    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
            <div className="flex items-center justify-center p-4 relative">
                <img className="w-full max-w-sm md:max-w-md object-cover rounded-lg" src={`/images/${product?.imageUrl}`} alt={product?.name} />
                <span className="absolute bottom-4 right-4 text-red-500 text-xl font-bold">{product?.price}€</span>
            </div>
